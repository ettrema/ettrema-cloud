...
public class StateTokenDaoImpl {
    ...
    public static class StateTokenTable extends com.ettrema.db.Table {
        ...
        public final Field<Long> currentCrc = add("currentCrc", FieldTypes.LONG, true); // the last backed up crc of this local file
        public final Field<Long> currentModDate = add("currentModDate", FieldTypes.LONG, true); // the date/time which the file was backed up, or that it was first discoverd assert having been backed up;
        public final Field<Long> backedupCrc = add("backedupCrc", FieldTypes.LONG, true); // the last backed up crc of this local file
        public final Field<Long> backedupDate = add("backedupDate", FieldTypes.LONG, true); // the date/time which the file was backed up, or that it was first discoverd assert having been backed up;
