 ...
 * rules mechanism.
 * 
 * For example, when permitting uploads or downloads the user should be able
 * to select a maximum file size to automatically permit. Files larger then that
 * will still need manual authorisation.
 * 
 * This should also allow users to choose when to upload/download new folders, or
 * to add them to an ignored list.
 *
 * @author brad
 */
