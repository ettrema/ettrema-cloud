...
import com.ettrema.backup.engine.Scanner;
...
public class QueueView extends javax.swing.JFrame implements EventListener {
    ...
    public QueueView( Engine engine, EventManager eventManager, QueueManager queueProcessor, Queue queue, Repo repo ) {
        this.queue = queue;
        this.engine = engine;
        this.repo = repo;
...
//        tblQueue.setRowSorter( rowSorter );
        ...
        if( scanner != null ) {
            File scanDir = scanner.getScanDir();
            if( scanDir != null ) {
    ...
    private String getNextScanText() {
        long nextScanTime = _( FileWatcher.class ).delayUntilNextScanSecs() * 1000 + System.currentTimeMillis();
