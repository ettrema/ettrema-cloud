...
/**
 * Listens to events and progress notifications, to provide simpler UI event
 * data to the UI
 *
 * @author brad
 */
public class SummaryDetails implements EventListener, ProgressListener {
    ...
    public SummaryDetails(ThrottleFactory throttleFactory, EventManager eventManager, Config config, BandwidthService bandwidthService, QueueManager queueManager) {
    ...
    /**
     * Called on the progress listener by the HTTP client after upload has
     * completed
     *
     * @param fileName
     */
