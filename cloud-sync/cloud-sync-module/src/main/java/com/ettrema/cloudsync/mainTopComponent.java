...
//            System.exit(9);
    ...
    private void initComponents() {
        ...
        lblStatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ettrema/cloudsync/tick.jpg"))); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(lblStatus, org.openide.util.NbBundle.getMessage(mainTopComponent.class, "mainTopComponent.lblStatus.text")); // NOI18N

        lblHeading.setFont(new java.awt.Font("Segoe UI", 0, 19)); // NOI18N
        lblHeading.setForeground(new java.awt.Color(127, 176, 50));
        org.openide.awt.Mnemonics.setLocalizedText(lblHeading, org.openide.util.NbBundle.getMessage(mainTopComponent.class, "mainTopComponent.lblHeading.text")); // NOI18N

        lblComment.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(lblComment, org.openide.util.NbBundle.getMessage(mainTopComponent.class, "mainTopComponent.lblComment.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(lblHeading1, org.openide.util.NbBundle.getMessage(mainTopComponent.class, "mainTopComponent.lblHeading1.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(lblHeading2, org.openide.util.NbBundle.getMessage(mainTopComponent.class, "mainTopComponent.lblHeading2.text")); // NOI18N

        lblTimeRemainingVal.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(lblTimeRemainingVal, org.openide.util.NbBundle.getMessage(mainTopComponent.class, "mainTopComponent.lblTimeRemainingVal.text")); // NOI18N

        lblCurrentVal.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(lblCurrentVal, org.openide.util.NbBundle.getMessage(mainTopComponent.class, "mainTopComponent.lblCurrentVal.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(lblHeading3, org.openide.util.NbBundle.getMessage(mainTopComponent.class, "mainTopComponent.lblHeading3.text")); // NOI18N

        lblOverallProgressVal.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(lblOverallProgressVal, org.openide.util.NbBundle.getMessage(mainTopComponent.class, "mainTopComponent.lblOverallProgressVal.text")); // NOI18N

        lblUsageVal.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(lblUsageVal, org.openide.util.NbBundle.getMessage(mainTopComponent.class, "mainTopComponent.lblUsageVal.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(lblHeading4, org.openide.util.NbBundle.getMessage(mainTopComponent.class, "mainTopComponent.lblHeading4.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(lblHeading5, org.openide.util.NbBundle.getMessage(mainTopComponent.class, "mainTopComponent.lblHeading5.text")); // NOI18N
